...
pub(crate) struct CapstoneArchInfo<'a> {
    /// name of C header
    header_name: &'a str,
...
impl<'a> CapstoneArchInfo<'a> {
    ...
    pub(crate) fn cs_name(&self) -> &str {
        self.cs_name
    }
}

pub(crate) static ARCH_INCLUDES: &[CapstoneArchInfo<'static>] = &[
    CapstoneArchInfo {
        header_name: "arm.h",
        cs_name: "arm",
    },
...
pub(crate) static BINDINGS_FILE: &str = "capstone_sys_dep.rs";
pub(crate) static BINDINGS_IMPL_FILE: &str = "capstone_archs_impl.rs";
