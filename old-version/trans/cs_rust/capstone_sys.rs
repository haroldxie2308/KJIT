...
// I'm not gonna use everything but the compiler is yelling at me!
#![allow(unused)]

use core::ffi::c_int;

// Bindings should be copied here
include!("capstone_sys_dep.rs");
include!("capstone_archs_impl.rs");

pub(crate) const CS_SUPPORT_DIET: c_int = (cs_arch::CS_ARCH_ALL as c_int) + 1;
pub(crate) const CS_SUPPORT_X86_REDUCE: c_int = (cs_arch::CS_ARCH_ALL as c_int) + 2;

include!("capstone_sys_common.rs");